...
@WebServlet("/RickAndMortyPage")
public class RickAndMortyPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// get counter
				...
				out.print("<title>Rick and Morty Page</title>");
				out.print("</head>");
				out.print("<body>");
				...
				out.print("<div class=\"container\">");
				out.print("<h1 class=\"display-4\">You Voted for Rick and Morty</h1>");
				out.print("<p class=\"lead\">Check out the analytics below!</p>");
				out.print("</div>");
				out.print("</div> ");
				
				out.print("<div class=\"container\">");
				out.print("<h2 class=\"text-left\">Rick and Morty</h2>");
				out.print("<div class=\"row\">");

				out.print("<img src=\"images/rick-and-morty.jpg\" class=\"col-md-6 pull-left\">");
