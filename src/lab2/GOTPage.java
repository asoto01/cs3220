...
@WebServlet("/GOTPage")
public class GOTPage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.print("<title>Game of Thrones Page</title>");
		out.print("</head>");
		out.print("<body>");
		...
		out.print("<div class=\"container\">");
		out.print("<h1 class=\"display-4\">You Voted for Game of Thrones</h1>");
		out.print("<p class=\"lead\">Check out the analytics below!</p>");
		out.print("</div>");
		out.print("</div> ");

		out.print("<div class=\"container\">");
		out.print("<h2 class=\"text-left\">Game of Thrones</h2>");
		out.print("<div class=\"row\">");

		out.print("<img src=\"images/got-2019.jpg\" class=\"col-md-6 pull-left\">");
